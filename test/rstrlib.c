...
/*  ======================================================================
    This file supplies the functionality to read and write Dore rasterfile
    images.
    ====================================================================== */
 ...
 */
static int
bigendian_word_byte_order()
{
#define BYTES_TO_CHK 4
   typedef unsigned int integer;
   integer i;
   char c[16];
   integer big_endian    = 0x3c5aa5c3;
   integer little_endian = 0xc3a55a3c;
 ...
 */
static void
error_message(error, filename, msg)
char *error;
char *filename;
char *msg;
{
 ...
 */
static int
process_attr_value (attr, val_cnt, value, header)
TokenType attr;
int val_cnt;
ValueStruct *value;
RasterHeader *header;
 ...
 */
DtInt
read_aif_file (filename, width, height, depth, type, data)
char *filename;
DtInt *width;
DtInt *height;
DtInt *depth;
 ...
 */
DtInt 
write_aif_file (filename, width, height, depth, type, data)
char *filename;
DtInt width;
DtInt height;
DtInt depth;
