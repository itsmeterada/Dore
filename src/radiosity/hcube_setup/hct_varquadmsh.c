...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_varquadmsh_hcube_setup()
    ...
    dot_object *object)
{
    ...
    if (!DDcondex_QueryRender(DsInqClassId("DoVarQuadMesh")))
         return;
    ...
    if (varquadmsh->alt_object_tris != DcNullObject)
       (varquadmsh->alt_object_tris)->ref_count += 1;
