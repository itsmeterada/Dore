...
/*
 ======================================================================
 Functions:
   dpr_radiosity_tristrip_hcube_setup

 ======================================================================
 */

void dpr_radiosity_tristrip_hcube_setup (
    dot_object *object)
{
    ...
    if (add_data->patchRad == DcNullPtr) {
        ...
        size = tristrip->vertex_count*sizeof(DtRealTriple);
    ...
    size = sizeof(DtRealTriple)*tristrip->vertex_count;
    transf_vertices = (DtRealTriple *)DDspace_Allocate(size);

    dpr_radiosity_transform_vertices(tristrip->vertex_location,
