...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_quadmsh_hcube_setup()
    ...
    dot_object *object)
{
    ...
    if (!DDcondex_QueryRender(DsInqClassId("DoQuadMesh")))
         return;
    ...
    if (quadmsh->alt_object_tris != DcNullObject)
       (quadmsh->alt_object_tris)->ref_count += 1;
