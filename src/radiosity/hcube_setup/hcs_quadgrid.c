...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_quadgrid_hcube_setup()
    ...
    dot_object *object)
{
    ...
    if (!DDcondex_QueryRender(DsInqClassId("DoQuadGrid")))
         return;
    ...
    if (quadgrid->alt_object_tris != DcNullObject)
       (quadgrid->alt_object_tris)->ref_count += 1;
