...
/*
 ======================================================================
 Functions:
   void dpr_radiosity_vartrimsh_hcube_setup(object)

 ======================================================================
 */

void
dpr_radiosity_vartrimsh_hcube_setup(object)
dot_object *object;
{
    ...
    if (add_data->patchRad == DcNullPtr) {
        ...
        size = sizeof(DtReal)*vartrimsh->triangle_count; 
        triplesize = sizeof(DtRealTriple)*vartrimsh->triangle_count;
    ...
    size = sizeof(DtRealTriple)*vartrimsh->vertex_count;
    transf_vertices = (DtRealTriple *)DDspace_Allocate(size);

    dpr_radiosity_transform_vertices(vartrimsh->vertex_location,
