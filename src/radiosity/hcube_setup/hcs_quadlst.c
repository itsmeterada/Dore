...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_quadlst_hcube_setup()
    ...
    dot_object *object)
{
   ...
   /* no radiosity allowed on alt. line representation */
    ...
    if (!DDcondex_QueryRender(DsInqClassId("DoQuadList")))
         return;
    ...
    if (quadlst->alt_object_tris != DcNullObject)
       (quadlst->alt_object_tris)->ref_count += 1;
