...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_varquadgrid_hcube_setup()
    ...
    dot_object *object)
{
    ...
    if (!DDcondex_QueryRender(DsInqClassId("DoVarQuadGrid")))
         return;
    ...
    if (varquadgrid->alt_object_tris != DcNullObject)
       (varquadgrid->alt_object_tris)->ref_count += 1;
