...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_sphlst_hcube_setup()
    ...
    dot_object *object)
{
    ...
    if (!DDcondex_QueryRender(DsInqClassId("DoSphereList")))
         return;
    ...
    if (sphlst->alternate_object != DcNullObject)
       (sphlst->alternate_object)->ref_count += 1;
