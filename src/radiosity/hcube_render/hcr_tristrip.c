...
/*
 ======================================================================
 Functions:
    dpr_radiosity_tristrip_hcube_render
...
void dpr_radiosity_tristrip_hcube_render (
    dot_object *object)
{
    ...
    current_vertexcolors = tristrip->vertex_color;
    tristrip->vertex_color = DcNullPtr;
   ...
   tristrip->vertex_color = current_vertexcolors;
