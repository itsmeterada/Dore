...
/*
 ======================================================================
 Functions:
    void dpr_radiosity_trilst_hcube_render(object)
...
void dpr_radiosity_trilst_hcube_render (
    dot_object *object)
{
    ...
    current_vertexcolors = trilst->vertex_color;
    trilst->vertex_color = DcNullPtr;
   ...
   trilst->vertex_color = current_vertexcolors;
