...
/*
 ...
 Functions:
    ...
    dpr_radiosity_vartristrip_hcube_distrib

 ======================================================================
 */

void dpr_radiosity_vartristrip_hcube_distrib (
    dot_object *object)
{
    ...
    DtReal ff;
    DtInt i, int_elem_color, tricount;
              ...
              the ratio if the areas (using reciprocity) */
               ...
               if (add_data->patchArea[i] != 0.)
                   ...
                   DDerror(ERR_RAD_ZERO_AREA,
                      "dpr_radiosity_vartristrip_hcube_distrib", DcNullPtr);
