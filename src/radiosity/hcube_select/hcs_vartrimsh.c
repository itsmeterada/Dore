...
/*
 ...
 Functions:
    ...
    dpr_radiosity_vartrimsh_hcube_select

 ======================================================================
 */

void dpr_radiosity_vartrimsh_hcube_select (
    dot_object *object)
{
    ...
    for (i=0; i<vartrimsh->triangle_count; i++){
        ...
        if (patch_energy > dpe_rad_brightest_patch.energy) {
            ...
            vertex0 = vartrimsh->triangle_vertexlist[i][0];
            vertex1 = vartrimsh->triangle_vertexlist[i][1];
            vertex2 = vartrimsh->triangle_vertexlist[i][2];
            ...
            dpe_rad_brightest_patch.vertices[0][0] =
                          vartrimsh->vertex_location[vertex0][0];
            dpe_rad_brightest_patch.vertices[0][1] =
                          vartrimsh->vertex_location[vertex0][1];
            dpe_rad_brightest_patch.vertices[0][2] =
                          vartrimsh->vertex_location[vertex0][2];

            dpe_rad_brightest_patch.vertices[1][0] =
                          vartrimsh->vertex_location[vertex1][0];
            dpe_rad_brightest_patch.vertices[1][1] =
                          vartrimsh->vertex_location[vertex1][1];
            dpe_rad_brightest_patch.vertices[1][2] =
                          vartrimsh->vertex_location[vertex1][2];

            dpe_rad_brightest_patch.vertices[2][0] =
                          vartrimsh->vertex_location[vertex2][0];
            dpe_rad_brightest_patch.vertices[2][1] =
                          vartrimsh->vertex_location[vertex2][1];
            dpe_rad_brightest_patch.vertices[2][2] =
                          vartrimsh->vertex_location[vertex2][2];
