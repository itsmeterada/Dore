...
/*
 ...
 Functions:
    ...
    dpr_radiosity_vartristrip_hcube_select

 ======================================================================
 */

void dpr_radiosity_vartristrip_hcube_select (
    dot_object *object)
{
    ...
    for (i=0; i<tricount; i++){
        ...
        if (patch_energy > dpe_rad_brightest_patch.energy) {
            ...
            dpe_rad_brightest_patch.vertices[0][0] =
                          vartristrip->vertex_location[i][0];
            dpe_rad_brightest_patch.vertices[0][1] =
                          vartristrip->vertex_location[i][1];
            dpe_rad_brightest_patch.vertices[0][2] =
                          vartristrip->vertex_location[i][2];
