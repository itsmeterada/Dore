...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_varquadmsh_show_render(object)

 ======================================================================
 */

void
dpr_radiosity_varquadmsh_show_render(object)
dot_object *object;
{
    ...
    renderable = DDcondex_QueryRender(DsInqClassId("DoVarQuadMesh"));
    ...
    if (radswi == DcOff) {
        ...
        if (reptype == DcOutlines ||
            reptype != DcOutlines && varquadmsh->alt_object_tris == DcNullPtr) {
           ...
           if (!renderable)
            ...
            exec_rtn = DDobject_InqMethod(varquadmsh->alt_object_tris,
                           dpe_rad_show_data.show_render_method_id);
           (*exec_rtn)(varquadmsh->alt_object_tris);
        }
