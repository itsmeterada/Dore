...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_varquadgrid_show_render(object)

 ======================================================================
 */

void dpr_radiosity_varquadgrid_show_render (
    dot_object *object)
{
    ...
    renderable = DDcondex_QueryRender(DsInqClassId("DoVarQuadGrid"));
    ...
    if (radswi == DcOff) {
        ...
        if (reptype == DcOutlines ||
           (reptype != DcOutlines && varquadgrid->alt_object_tris == DcNullPtr)){
           ...
           if (!renderable)
            ...
            exec_rtn = DDobject_InqMethod(varquadgrid->alt_object_tris,
                           dpe_rad_show_data.show_render_method_id);
           (*exec_rtn)(varquadgrid->alt_object_tris);
        }
