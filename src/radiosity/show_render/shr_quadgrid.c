...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_quadgrid_show_render(object)

 ======================================================================
 */

void dpr_radiosity_quadgrid_show_render (
    dot_object *object)
{
    ...
    renderable = DDcondex_QueryRender(DsInqClassId("DoQuadGrid"));
    ...
    if (radswi == DcOff) {
        ...
        if (reptype == DcOutlines ||
           (reptype != DcOutlines && quadgrid->alt_object_tris == DcNullPtr)) {
           ...
           if (!renderable)
            ...
            exec_rtn = DDobject_InqMethod(quadgrid->alt_object_tris,
                           dpe_rad_show_data.show_render_method_id);
           (*exec_rtn)(quadgrid->alt_object_tris);
        }
