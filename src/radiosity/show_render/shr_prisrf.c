...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_prisrf_show_render(object)

 ======================================================================
 */

void dpr_radiosity_prisrf_show_render (
    dot_object *object)
{
    ...
    renderable = DDcondex_QueryRender(DsInqClassId("DoPrimSurf"));
    ...
    if (radswi == DcOff) {
        ...
        if (prisrf->alternate_object == DcNullPtr) {
            ...
            exec_rtn = DDobject_InqMethod(prisrf->alternate_object,
                           dpe_rad_show_data.show_render_method_id);
            (*exec_rtn)(prisrf->alternate_object);
