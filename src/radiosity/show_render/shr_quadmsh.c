...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_quadmsh_show_render(object)

 ======================================================================
 */

void dpr_radiosity_quadmsh_show_render (
    dot_object *object)
{
    ...
    renderable = DDcondex_QueryRender(DsInqClassId("DoQuadMesh"));
    ...
    if (radswi == DcOff) {
        ...
        if ((reptype == DcOutlines) ||
            ((reptype != DcOutlines) && (!quadmsh->alt_object_tris))){
           ...
           if (!renderable)
            ...
            exec_rtn = DDobject_InqMethod(quadmsh->alt_object_tris,
                           dpe_rad_show_data.show_render_method_id);
           (*exec_rtn)(quadmsh->alt_object_tris);
        }
