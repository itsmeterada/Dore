...
/*
 ...
 Functions:
   ...
   void dpr_radiosity_plymsh_show_render(object)

 ======================================================================
 */

void dpr_radiosity_plymsh_show_render (
    dot_object *object)
{
    ...
    renderable = DDcondex_QueryRender(DsInqClassId("DoPolygonMesh"));
    ...
    if (radswi == DcOff) {
        ...
        if ((reptype == DcOutlines) ||
            ((reptype != DcOutlines) && (!plymsh->alt_object_tris))) {
           ...
           if (!renderable)
            ...
            exec_rtn = DDobject_InqMethod(plymsh->alt_object_tris,
                           dpe_rad_show_data.show_render_method_id);
           (*exec_rtn)(plymsh->alt_object_tris);
        }
