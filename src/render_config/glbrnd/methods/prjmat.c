...
/*
  ======================================================================
  Functions:
	int drr_glbrnd_projection_initialize (object)
...
void drr_glbrnd_projection_initialize (dot_object *object)
{
   struct projection_data *projectiondata;

   projectiondata = (struct projection_data *)object->data;

   drr_glbrnd_set_projection_matrix(&projectiondata->window, 
