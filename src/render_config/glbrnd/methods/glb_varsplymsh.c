...
/*
  ======================================================================
  Functions:
	int drr_glbrnd_varsimplymsh_initialize_objects (object)
...
void drr_glbrnd_varsimplymsh_initialize_objects (dot_object *object)
{
   dot_object *alt;
   static DtInt class_id = -1;

   if (class_id == -1) {
      class_id = DsInqClassId("DoVarSimplePolygonMesh");
   }
