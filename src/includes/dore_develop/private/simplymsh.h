#ifndef DD_SIMPLYMSH_H
#define DD_SIMPLYMSH_H
...
void        dor_simplymsh_calculate_vertex_normals  (struct simplymsh *);
DtFlag      dor_simplymsh_check_complex_edge
		    (struct simplymsh *, dot_gpolyd_interpolated_vertex *,
		     dot_gpolyd_interpolated_vertex *);
void        dor_simplymsh_compute_bounding_volume  (dot_object *);
dot_object* dor_simplymsh_create 
		    (DtColorModel, DtVertexType, DtInt, DtReal*, DtInt, DtInt[],
		     DtInt [], DtShapeType, DtFlag);
dot_object* dor_simplymsh_create_alternate_geom_lines  (struct simplymsh *);
dot_object* dor_simplymsh_create_alternate_geom_tris  (struct simplymsh *);
...
void        dor_simplymsh_destroy  (dot_object *);
...
void        dor_simplymsh_pick  (dot_object *);
void        dor_simplymsh_pick_lines  (dot_object *);
void        dor_simplymsh_pick_tris  (dot_object *);
void        dor_simplymsh_polygon_normal
		    (struct simplymsh *, DtInt, DtInt, DtRealTriple);
void        dor_simplymsh_print  (struct object *);
void        dor_simplymsh_render_standard  (dot_object *);
dot_object* dor_simplymsh_update_alternate  (dot_object *);
dot_object* dor_simplymsh_update_lines  (dot_object *);
dot_object* dor_simplymsh_update_tris  (dot_object *);
