...
/*
  ======================================================================
  Functions:
	int ddr_x11_XFDI_drom_plylin_render (object)
...
/*
 ======================================================================
 */
ddr_x11_XFDI_drom_plylin_render(object)
     dot_object *object;
{
    ...
    if (classid == -1) {
	classid = DsInqClassId("DoPolyline");
    }
	...
	if (colordata->converted_clrs == NULL) {
	    colordata->converted_clrs = (unsigned long *) DDspace_Allocate
		    (plylin->vertex_count*sizeof(unsigned long));
	    ddr_x11_XFDI_drom_pri_convert_colors(plylin->vertex_count,
						  plylin->vertex_color,
	...
	ddr_x11_XFDI_drom_output_pntlst(plylin->bounding_box_pts,
					 plylin->vertex_count,
					 DcNullPtr,
	...
	ddr_x11_XFDI_drom_output_plylin(plylin->bounding_box_pts,
					 plylin->vertex_count,
					 DcNullPtr,
					 plylin->vertex_location,
					 plylin->vertex_normal,
