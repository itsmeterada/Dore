...
/*
  ======================================================================
  Functions:
	DtPtr ddr_vll_drom_filerstr_create (object)
	void ddr_vll_drom_filerstr_print (object, data)
	void ddr_vll_drom_filerstr_delete (object, data)
	void ddr_vll_drom_filerstr_update (object)
 ...
 */
DtPtr
ddr_vll_drom_filerstr_create(object)
	DtObject object;
{
    return (DcNullPtr);
}
 ...
 */
void
ddr_vll_drom_filerstr_print(object, data)
	DtObject object;
 ...
 */
void
ddr_vll_drom_filerstr_delete(object, data)
	DtObject object;
	DtObjectStructure *data;
{
 ...
 */
void
ddr_vll_drom_filerstr_update (object)
