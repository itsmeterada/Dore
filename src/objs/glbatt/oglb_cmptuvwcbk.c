...
/*
  ...
  Functions:
	...
	dor_global_cmptexuvwcbk_set_value 
	dor_global_cmptexuvwcbk_push_value 
	dor_global_cmptexuvwcbk_pop_value 
	dor_global_cmptexuvwcbk_pop_group 
	dor_global_cmptexuvwcbk_get_value 
	dor_global_cmptexuvwcbk_get_data_pointer 
	dor_global_cmptexuvwcbk_update_execute 
	dor_global_cmptexuvwcbk_destroy_element 

  ======================================================================
 */
#include "global.h"

dot_object *doe_global_cmptexuvwcbk_object;
DtInt doe_global_cmptexuvwcbk_class_id;
/*
 ======================================================================
 */

static DtMethodEntry methods[] = {
    { DcMethodInqGlbAttVal, (DtMethodPtr) dor_global_cmptexuvwcbk_get_value }
};
...
void dor_global_cmptexuvwcbk_initialize (void)
{
    ...
    doe_global_cmptexuvwcbk_class_id = dor_class_add (
					   "AttCompTextureUVWCallback", 
					   1, methods, DcNullPtr);

    gas = dor_gas_create(dor_global_cmptexuvwcbk_destroy_element);

    doe_global_cmptexuvwcbk_object = dor_object_create(
			doe_global_cmptexuvwcbk_class_id,gas);

    dor_global_cmptexuvwcbk_push_value(DcStdUVWCallback);
}
/*
 ======================================================================
 */

void dor_global_cmptexuvwcbk_set_value (
    DtObject value)
{
    DtObject *dataptr;
    ...
    if (dor_gas_test_set_value(doe_global_cmptexuvwcbk_object->data)) {
	dor_global_cmptexuvwcbk_push_value(value);
    } else {
	dataptr = dor_global_cmptexuvwcbk_get_data_pointer();
...
void dor_global_cmptexuvwcbk_push_value (
    DtObject value)
{
    DtObject *newvalue;
    ...
    *newvalue = value;
    ...
    if (dor_gas_push_value(doe_global_cmptexuvwcbk_object->data,newvalue)) {
	currentgroup = dor_group_get_current_group();

	dor_group_record_attribute(currentgroup,dor_global_cmptexuvwcbk_pop_group);
    }
...
DtFlag dor_global_cmptexuvwcbk_pop_value (void)
{
    ...
    popflag = dor_gas_pop_value(doe_global_cmptexuvwcbk_object->data,&value);

    dor_global_cmptexuvwcbk_destroy_element(value);
...
{
    dor_gas_pop_group(doe_global_cmptexuvwcbk_object->data);
...
DtFlag dor_global_cmptexuvwcbk_get_value (
    DtObject *value)
{
    DtFlag getflag;
    DtPtr currentvalue;

    getflag = dor_gas_get_value(doe_global_cmptexuvwcbk_object->data,
				&currentvalue);

    if (!getflag) {
	DDerror (ERR_NO_CURRENT_VALUE,
		    "dor_global_cmptexuvwcbk_get_value", DcNullPtr);
	return(DcFalse);
    }
...
DtObject *dor_global_cmptexuvwcbk_get_data_pointer (void)
{
    ...
    getflag = dor_gas_get_value(doe_global_cmptexuvwcbk_object->data,&dataptr);

    if (!getflag) {
	DDerror (ERR_NO_CURRENT_VALUE,
		    "dor_global_cmptexuvwcbk_get_data_pointer", DcNullPtr);
...
void dor_global_cmptexuvwcbk_update_execute (void)
{
    ...
    executemethod = dor_object_get_current_method(doe_global_cmptexuvwcbk_object);
...
void dor_global_cmptexuvwcbk_destroy_element (
    DtObject *element)
{
