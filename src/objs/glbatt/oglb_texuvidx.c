...
/*
  ...
  Functions:
	...
	dor_global_texuvidx_set_value 
	dor_global_texuvidx_push_value 
	dor_global_texuvidx_pop_value 
	dor_global_texuvidx_pop_group 
	dor_global_texuvidx_get_value 
	dor_global_texuvidx_get_data_pointer 
	dor_global_texuvidx_update_execute 
	dor_global_texuvidx_destroy_element 

  ======================================================================
 */
#include "global.h"

dot_object *doe_global_texuvidx_object;
DtInt doe_global_texuvidx_class_id;
/*
 ======================================================================
 */
...
static DtMethodEntry methods[] = {
    { DcMethodInqGlbAttVal, (DtMethodPtr)dor_global_texuvidx_get_value }
};
...
void dor_global_texuvidx_initialize (void)
{
    ...
    doe_global_texuvidx_class_id = dor_class_add ("AttTextureUVIndex", 1,
						  methods,DcNullPtr);

    gas = dor_gas_create(dor_global_texuvidx_destroy_element);

    doe_global_texuvidx_object = dor_object_create(doe_global_texuvidx_class_id,gas);

    dor_global_texuvidx_push_value(0);
}
/*
 ======================================================================
 */

void dor_global_texuvidx_set_value (
    DtInt index)
{
    DtInt *dataptr;
    ...
    if (dor_gas_test_set_value(doe_global_texuvidx_object->data)) {
	dor_global_texuvidx_push_value(index);
    } else {
	dataptr = dor_global_texuvidx_get_data_pointer();
...
void dor_global_texuvidx_push_value (
    DtInt value)
{
    DtInt *newvalue;
    ...
    *newvalue = value;
    ...
    if (dor_gas_push_value(doe_global_texuvidx_object->data,newvalue)) {
	currentgroup = dor_group_get_current_group();

	dor_group_record_attribute(currentgroup,dor_global_texuvidx_pop_group);
    }
...
DtFlag dor_global_texuvidx_pop_value (void)
{
    ...
    popflag = dor_gas_pop_value(doe_global_texuvidx_object->data,&value);

    dor_global_texuvidx_destroy_element(value);
...
{
    dor_gas_pop_group(doe_global_texuvidx_object->data);
...
DtFlag dor_global_texuvidx_get_value (
    DtInt *value)
{
    DtFlag getflag;
    DtPtr currentvalue;

    getflag = dor_gas_get_value(doe_global_texuvidx_object->data,&currentvalue);

    if (!getflag) {
	DDerror (ERR_NO_CURRENT_VALUE,
		    "dor_global_texuvidx_get_value", DcNullPtr);
...
DtInt *dor_global_texuvidx_get_data_pointer (void)
{
    ...
    getflag = dor_gas_get_value(doe_global_texuvidx_object->data,&dataptr);
...
void dor_global_texuvidx_update_execute (void)
{
    ...
    executemethod = dor_object_get_current_method(doe_global_texuvidx_object);
...
void dor_global_texuvidx_destroy_element (
    DtInt *element)
{
